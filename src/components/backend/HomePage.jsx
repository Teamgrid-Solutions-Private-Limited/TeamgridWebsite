      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {backendData.heroTitle}
              <Box component="span" sx={{ display: "block", mt: 1 }}>
                {backendData.heroSubtitle[0]}{" "}
                <Box component="span" sx={{ color: "#30ECAD" }}>
                  {backendData.heroSubtitle[1]}
                </Box>
              </Box>
              <Box component="span" sx={{ display: "block" }}>
                {backendData.heroHighlight}
              </Box>
            </Typography>
            ...
            >
              <Button
                variant={backendData.buttons[0].variant}
                sx={{
                  bgcolor:
              ...
              >
                {backendData.buttons[0].text}
              </Button>
              <Button
                variant={backendData.buttons[1].variant}
