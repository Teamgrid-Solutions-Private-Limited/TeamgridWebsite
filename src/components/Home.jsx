...
function Home() {
  ...
  useEffect(() => {
    const updateOrbitScale = () => {
      ...
      ); // Clamp between 0.5 and 2 for sanity
      setOrbitScale(scale);
    };
    updateOrbitScale();
        ...
        {isMd || isLg || isXl ? (
          ...
          >
            ...
            {[
              ...
              { icons: techIcons.slice(0, 8), positions: 16 }, // outermost, repeat to fill 16
            ].map((orbit, orbitIdx) => {
